...
public class JwtTokenUtil implements Serializable {
	...
	public String generateToken(Employee employee, Date issuedAt, Date expiresAt) {
		Map<String, Object> claims = new HashMap<>();
		return doGenerateToken(claims, String.valueOf(employee.getId()),issuedAt,expiresAt);
	}
